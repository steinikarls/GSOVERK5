<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSOVERK5/title.php');?> 	
<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSOVERK5/random_image.php');?> 
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		<div id="wrapper">
			...
			<nav id="navigation">
				<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSOVERK5/header.php');?> 	
			</nav>
			<div class="container">
        <?php 
        $imagename = $urlimage = "";
          if (!isset($_POST['myndaslod'])) {
            include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSOVERK5/process.php');
          }
          else{
            ...
            if (empty($myndanafn) || empty($myndaslod)){
              ...
              include_once($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSOVERK5/process.php');
              }
              else{
                if ($birta == 'option1') {
         ...
         ?>
			...
			<footer>
				<?php include ($_SERVER['DOCUMENT_ROOT'] . '/2t/1810943469/GSOVERK5/footer.php');?> 	
			</footer>
